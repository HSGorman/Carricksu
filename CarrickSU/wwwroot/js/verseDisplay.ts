...
module verseDisplay {
    export class verseDisplayAnimation {
        ...
        private _maxWidth: number = 750;
        private _maxHeight: number = 550;
        ...
        private InitializeStage() {
            ...
            this._animShrink = new Kinetic.Animation((frame) => {
                ...
                this._memoryVerseKineticImage.setHeight(this._maxHeight * this._scale);
                this._memoryVerseKineticImage.setWidth(this._maxWidth * this._scale);
            }, this._layer1);
